...
import { createJWT, verifyJWT, WenzhenTestJWT } from '../controllers/jwtControllers.js'
...
router.get('/verifyuser', verifyJWT, (req: Request, res: Response): void => { res.status(200).json(res.locals.user) });
// Chatlog routes
