...
router.get('/getallchatlogs', verifyJWT, getChatHistoryRedis, createJWT, (req: Request, res: Response): void => { res.status(200).json(res.locals.redisQueryResult) }); // Expecting chatroom_id from frontend
