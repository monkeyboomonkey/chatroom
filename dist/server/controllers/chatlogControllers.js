...
export async function getAllChatlogs(req, res, next) {
    ...
    try {
        ...
        const chatlogs_in_chatroom_username = await db.select({ username: users.username, timestamp: chatlogs_in_chatroom.timestamp, message: chatlogs_in_chatroom.message })
            .from(users)
...
export function addChatlog(req, res, next) {
...
//# sourceMappingURL=chatlogControllers.js.map